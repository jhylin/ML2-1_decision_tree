...
RDKit docs - descriptors
Datamol's molecular descriptors code - check documentations
Useful blog posts by P. Zin
Check blog posts by P. Walters & G. Landrum?

To consider:
0D - 2D descriptors or only 2D?
Likely not going to use fingerprints yet?

```{python}
# Datamol sample descriptor code to create mol descriptors for batch compounds
