...
# then save as a new list
mol_ls = [Descriptors.CalcMolDescriptors(mol) for mol in mols]
# Convert the list into a dataframe
df_2d = pd.DataFrame(mol_ls)
df_2d.head()
print(df_2d.shape)
```

In total, it generated 209 descriptors. Then I tested Datamol's code on this.

```{python}
# Datamol descriptor code for batch compounds
