...
The dataframe would now look like this, with a new pIC50 column ready for use. Now, one question regarding to IC50 was whether it was a good idea to use IC50 values like this from public database like ChEMBL. This paper [@Kalliokoski2013a] may provide further things to consider.
